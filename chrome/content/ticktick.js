/*
Firefox plugin for dida.

AUTHOR
    dida: http://dida365.com/
...
var XULTickTick = {
    ...
    init: function() {
        ...
        XULTickTick.TickTick_SRC = 'http://dida365.com/';
        XULTickTick.TickTick_SIGN_OUT = 'http://dida365.com/signout';
    ...
    initInterface: function() {
        ...
        if(!sidebarBox.hidden && sidebarTitle.value.indexOf('滴答清单') != -1) {
    ...
    hideTickTick: function() {
        ...
        if(XULTickTick.TickTick_INTER_FACE && sidebarTitle.value.indexOf('滴答清单') == -1) {
